...
//        intent.`package` = "com.cn.annotation.annotationtest"//App A的包名
    ...
    private fun clickAction() {
        ...
        Log.e("dd======",count.toString())
//        var personList=imMyAidl!!.addList(Person("dfdf",11))
        var pserons:Person= Person("年龄", count.toInt())
        val personList: List<Person> = imMyAidl!!.addList(pserons)
        var str: StringBuilder? = StringBuilder(count.toString())
